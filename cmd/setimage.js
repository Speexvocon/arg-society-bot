...
exports.run = function(bot, msg, params) {
	...
	if (infoList[name] != null) {
  	infoList[name].imageURL = url

  	bot.delReply(msg, `Image added for info **${name}** has been added.`)
...
exports.help = {
  name: "setimage",
  description: "Adds an image to the info blob to the server.",
  usage: "setimage [name] [url]"
};
